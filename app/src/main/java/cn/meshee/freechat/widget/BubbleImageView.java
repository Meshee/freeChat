...
public class BubbleImageView extends AppCompatImageView {
    ...
    private void drawText(Canvas canvas, int radiusPx) {
        ...
        if (mShowShadow) {
            ...
            if (mArrowLocation == LOCATION_LEFT) {
                shadowRect = new Rect(mArrowWidth, 0, getWidth(), getHeight() - getHeight() * percent / 100);
            } else {
                shadowRect = new Rect(0, 0, getWidth() - mArrowWidth, getHeight() - getHeight() * percent / 100);
            }
        ...
        if (mShowText) {
            ...
            canvas.drawText(percent + "%", marginLeft, getHeight() / 2, mPaint);
        }
    }
